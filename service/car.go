...
func (u carService) Create(ctx context.Context, car models.Car) (string,error) {
	...
	if err != nil {
		log.Println("ERROR in service layer while creating car",err.Error())
		return "", err
	}
	return pkey,nil
}
...
func (u carService) Update(ctx context.Context, car models.Car) (string,error) {
	...
	if err != nil {
		log.Println("ERROR in service layer while updating car",err.Error())
		return "",err
	}
	return pkey,nil
}
...
func (u carService) GetByIDCar(ctx context.Context, id string) (models.Car,error) {
	...
	if err != nil {
		log.Println("ERROR in service layer while getting by id car",err.Error())
...
func (u carService) Delete(ctx context.Context, id string) (error) {
	...
	if err != nil {
		log.Println("ERROR in service layer while deleting car",err.Error())
		return err
	}
	return nil
}
...
func (u carService) GetCarAll(ctx context.Context,car models.GetAllCarsRequest) (models.GetAllCarsResponse, error) {
	...
	if err != nil {
		log.Println("ERROR in service layer while getting all cars",err.Error())
		return cars,err
	}
	return cars,nil
}
...
func (u carService) GetAvaibleCars(ctx context.Context,car models.GetAllCarsRequest) (models.GetAllCarsResponse, error) {
	...
	if err != nil {
		log.Println("ERROR in service layer while getting all cars with no customers",err.Error())
		return cars,err
	}
	return cars,nil
}
